...
We welcome you to [check the existing issues](https://github.com/ai-chem/DiMag/issues) for bugs or enhancements to work on.
If you have an idea for an extension to DiMag, please [file a new issue](https://github.com/ai-chem/DiMag/issues/new) so we can discuss it.

Make sure to familiarize yourself with the project layout before making any major contributions.

## How to contribute

1. Fork the [project repository](https://github.com/ai-chem/DiMag/): click on the 'Fork' button near the top of the page. This creates a copy of the code under your account on the GitHub server.
...
- Update the [README](https://github.com/ai-chem/DiMag/tree/main/README.md) if anything there has changed.
