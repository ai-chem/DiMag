...
about: Want us to add any features to DiMag?
title: 'enh: '
labels: enhancement
assignees: ''
...
<!--
  Hi! Thanks for considering to file a feature request with DiMag. Please take the time to
...
<!--
  Why do you want to see this feature in DiMag? What use cases does it support?
-->
